...
<input type="hidden" name="keyword" value="${param.keyword}">
  ...
  <a href="/searchPosting.do?curPage=${to.curPage}&criteria=${param.criteria}&keyword=${param.keyword}" class="alert-link">검색결과 게시글 목록</a></div>
	...
	<jsp:include page="searchPagePosting.jsp"/>	
			
	
	<div class="container"><jsp:include page="/posting/searchPosting.jsp"/></div>
